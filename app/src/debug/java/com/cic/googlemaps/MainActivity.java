...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback, View.OnClickListener {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng mexicoCity = new LatLng(40.4319077,116.5703749);
        mMap.addMarker(new MarkerOptions().position(mexicoCity).title("Muralla China"));
    ...
    public void onClick(View view) {
        ...
        mMap.addMarker(new MarkerOptions().position(sitios[Integer.valueOf(view.getTag().toString())]).title(((Button)view).getText().toString()));
        //mMap.moveCamera(CameraUpdateFactory.newLatLng(mexicoCity));
    }
}
